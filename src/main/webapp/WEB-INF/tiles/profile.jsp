...
<div id="registration-container">
 <form action="<c:url value="/profile"/>" method="POST">
	<div class="form-title">${messages['i18n.label.profile.firstname']}:</div>
	...
	<br/>
	<div class="form-title">${messages['i18n.label.profile.lastname']}:</div>
	...
	<br/>
	<div class="form-title">${messages['i18n.label.profile.age']}:</div>
	...
	<input type="submit" value="${messages['i18n.button.profile.save']}"/> <div class="form-err-message">${profileFormModel.mainMessage}</div>
	</div>
 </form>
</div>