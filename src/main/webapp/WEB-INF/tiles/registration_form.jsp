...
<div id="registration-container">
 <form action="<c:url value="/registration"/>" method="POST">
	<div class="form-title">${messages['i18n.label.register.email']}:</div>
	...
	<br/>
	<div class="form-title">${messages['i18n.label.register.psw1']}:</div>
	...
	<br/>
	<div class="form-title">${messages['i18n.label.register.psw2']}:</div>
	...
	<input type="submit" value="${messages['i18n.button.register.register']}"/>
	</div>
 </form>
</div>