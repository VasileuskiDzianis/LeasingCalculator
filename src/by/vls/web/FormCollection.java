...
import by.vls.model.calculator.CalcRequest;
import by.vls.model.user.*;
...
public class FormCollection {
    ...
    public static ArrayList getFormCalcReq() {
        ArrayList formCalc = new ArrayList();
    ...
    public static ArrayList getAuthForm() {
        ArrayList formAuth = new ArrayList();
    ...
    public static ArrayList getRegForm(int errcode) {
        ArrayList formReg = new ArrayList();
    ...
    public static ArrayList getLogOutForm(String user) {
        ArrayList formLogOut = new ArrayList();
    ...
    public static ArrayList getMenu(int user_status) {

        ArrayList formMenu = new ArrayList();
    ...
    public static ArrayList getErrorForm(String text) {
        ArrayList formLogOut = new ArrayList();
        formLogOut.add("<p class=\"error\">Сообщение: " + text + "</p>");
        return formLogOut;
    }

    public static ArrayList getAboutForm() {
        ArrayList formAbout = new ArrayList();
        formAbout.add("<p class=\"about\">Автор проекта: Denis Vasilevsky</br> e-mail: 4denver@mail.ru</br>Skype: d.vasilevsky</p>");
        return formAbout;
    }

   /* public static ArrayList getIdentBsnForm() {
        ArrayList formIdentBsn = new ArrayList();
        formIdentBsn.add("<p class=\"identity\">Identity form for business</p>");
        return formIdentBsn;
    }*/

    public static ArrayList getIdentPrvtForm(Person person) {
        ArrayList formIdentPrvt = new ArrayList();
    ...
    public static ArrayList getOrderPrvtForm() {
        ArrayList formOrderPrvt = new ArrayList();
        formOrderPrvt.add("<p class=\"order\">Order form for private person</p>");
        return formOrderPrvt;
    }

    public static ArrayList getOrderBsnForm() {
        ArrayList formOrderBsn = new ArrayList();
        formOrderBsn.add("<p class=\"order\">Order form for business</p>");
        return formOrderBsn;
    }

    public static ArrayList getCalcListForm(CalcRequest calcreq) {
        ArrayList formCalcList = new ArrayList();
    ...
    public static ArrayList getIdentBsnForm(Company company) {
        ArrayList formIdentPrvt = new ArrayList();
