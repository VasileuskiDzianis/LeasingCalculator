...
public class CalcRequest implements Serializable {
    ...
    public void buildPaymentList() {
        ...
        for (int i = 0; i < duration; i++) {
           ...
           /*System.out.printf("|Pay #:%2d |Date:%9s |Debt:%9.2f |MonthCost:%7.2f |Margin:%7.2f " +
                           "|CostVAT:%7.2f |MarginVAT:%7.2f |Whole:%7.2f |Insure:%7.2f%n",
                   (i+1), listDate.get(i),listRemainingDebt.get(i),listObjCost.get(i),listMargin.get(i),listObjCostVat.get(i),
                   listMarginVat.get(i), listWholePay.get(i), listInsurance.get(i));*/
        ...
        /*System.out.printf("Total: cost:%9.2f margin:%9.2f costVAT:%9.2f marginVAT:%9.2f WholePay: %9.2f%n",
                totalCost, totalMargin, totalCostVat, totalMarginVat, totalWholePay);
        System.out.printf("Summ: cost:%9.2f costVAT:%9.2f WholePay: %9.2f%n",
                sumCost, sumCostVat, sumWholePay);
        System.out.println(String.format("%7.3f" ,sumWholePay));*/
